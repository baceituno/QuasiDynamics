classdef NonlinearShapeRefinementProblem
	properties 
		prog
		object
		opti
	...
	methods
		...
		function obj = NonlinearShapeRefinementProblem(prog)
			assert(nargin > 0);
			...
			obj.N_l = prog.N_l;
			obj.N_T = prog.N_T;
			obj.N_v = prog.object{1}.nv;
			obj.N_task = length(prog.object);
		...
		function obj = addDecisionVariables(obj)
			...
			obj.vars.p = obj.opti.variable(2*obj.N_c*obj.N_l*obj.N_T*obj.N_task);
			obj.vars.dp = obj.opti.variable(2*obj.N_c*obj.N_l*obj.N_T*obj.N_task);
			obj.vars.ddp = obj.opti.variable(2*obj.N_c*obj.N_l*obj.N_T*obj.N_task);

			obj.vars.p_lambda = obj.opti.variable(2*obj.N_c*obj.N_l*obj.N_T*obj.N_task);
			obj.vars.f_lambda = obj.opti.variable(2*obj.N_c*obj.N_l*obj.N_T*obj.N_task);
			obj.vars.f_ext_lambda = obj.opti.variable(2*obj.N_v*obj.N_T*obj.N_task);

			obj.vars.f = obj.opti.variable(2*obj.N_c*obj.N_l*obj.N_T*obj.N_task);
			obj.vars.f_ext = obj.opti.variable(2*obj.N_v*obj.N_T*obj.N_task);

			% computes the indexes for each variable
			obj.idx.p = reshape(1:2*obj.N_c*obj.N_l*obj.N_T,[2,obj.N_c,obj.N_l,obj.N_T,obj.N_task]);
			obj.idx.dp = reshape(1:2*obj.N_c*obj.N_l*obj.N_T,[2,obj.N_c,obj.N_l,obj.N_T,obj.N_task]);
			obj.idx.ddp = reshape(1:2*obj.N_c*obj.N_l*obj.N_T,[2,obj.N_c,obj.N_l,obj.N_T,obj.N_task]);

			obj.idx.p_lambda = reshape(1:2*obj.N_c*obj.N_l*obj.N_T,[2,obj.N_c,obj.N_l,obj.N_T,obj.N_task]);
			obj.idx.f_lambda = reshape(1:2*obj.N_c*obj.N_l*obj.N_T,[2,obj.N_c,obj.N_l,obj.N_T,obj.N_task]);
			obj.idx.f_ext_lambda = reshape(1:2*obj.N_v*obj.N_T,[2,obj.N_v,obj.N_T,obj.N_task]);

			obj.idx.f = reshape(1:2*obj.N_c*obj.N_l*obj.N_T,[2,obj.N_c,obj.N_l,obj.N_T,obj.N_task]);
			obj.idx.f_ext = reshape(1:2*obj.N_v*obj.N_T,[2,obj.N_v,obj.N_T,obj.N_task]);
		end
