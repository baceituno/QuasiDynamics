classdef robot_IOSignalResponse < robotics.ros.Message
    %robot_IOSignalResponse MATLAB implementation of robot_comm/robot_IOSignalResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_IOSignalResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_IOSignalResponse(msg)
            %robot_IOSignalResponse Construct the message object robot_IOSignalResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_IOSignalResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_IOSignalResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_IOSignalResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_IOSignalResponse;
            obj.reload(strObj);
        end
    end
end
