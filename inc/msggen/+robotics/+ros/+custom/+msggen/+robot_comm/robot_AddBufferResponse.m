classdef robot_AddBufferResponse < robotics.ros.Message
    %robot_AddBufferResponse MATLAB implementation of robot_comm/robot_AddBufferResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_AddBufferResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_AddBufferResponse(msg)
            %robot_AddBufferResponse Construct the message object robot_AddBufferResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddBufferResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_AddBufferResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_AddBufferResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_AddBufferResponse;
            obj.reload(strObj);
        end
    end
end
