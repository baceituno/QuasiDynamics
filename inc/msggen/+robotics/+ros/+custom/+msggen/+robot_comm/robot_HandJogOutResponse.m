classdef robot_HandJogOutResponse < robotics.ros.Message
    %robot_HandJogOutResponse MATLAB implementation of robot_comm/robot_HandJogOutResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_HandJogOutResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_HandJogOutResponse(msg)
            %robot_HandJogOutResponse Construct the message object robot_HandJogOutResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_HandJogOutResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_HandJogOutResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_HandJogOutResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_HandJogOutResponse;
            obj.reload(strObj);
        end
    end
end
