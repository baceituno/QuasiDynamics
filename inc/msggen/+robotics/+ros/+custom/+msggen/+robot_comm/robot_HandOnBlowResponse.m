classdef robot_HandOnBlowResponse < robotics.ros.Message
    %robot_HandOnBlowResponse MATLAB implementation of robot_comm/robot_HandOnBlowResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_HandOnBlowResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_HandOnBlowResponse(msg)
            %robot_HandOnBlowResponse Construct the message object robot_HandOnBlowResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_HandOnBlowResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_HandOnBlowResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_HandOnBlowResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_HandOnBlowResponse;
            obj.reload(strObj);
        end
    end
end
