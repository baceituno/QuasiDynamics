classdef robot_AddJointPosBufferRequest < robotics.ros.Message
    %robot_AddJointPosBufferRequest MATLAB implementation of robot_comm/robot_AddJointPosBufferRequest
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_AddJointPosBufferRequest' % The ROS message type
    end
    ...
    methods
        function obj = robot_AddJointPosBufferRequest(msg)
            %robot_AddJointPosBufferRequest Construct the message object robot_AddJointPosBufferRequest
        ...
        function set.J1(obj, j1)
            ...
            validateattributes(j1, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddJointPosBufferRequest', 'J1');
        ...
        function set.J2(obj, j2)
            ...
            validateattributes(j2, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddJointPosBufferRequest', 'J2');
        ...
        function set.J3(obj, j3)
            ...
            validateattributes(j3, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddJointPosBufferRequest', 'J3');
        ...
        function set.J4(obj, j4)
            ...
            validateattributes(j4, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddJointPosBufferRequest', 'J4');
        ...
        function set.J5(obj, j5)
            ...
            validateattributes(j5, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddJointPosBufferRequest', 'J5');
        ...
        function set.J6(obj, j6)
            ...
            validateattributes(j6, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddJointPosBufferRequest', 'J6');
        ...
        function set.J7(obj, j7)
            ...
            validateattributes(j7, {'numeric'}, {'nonempty', 'scalar'}, 'robot_AddJointPosBufferRequest', 'J7');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_AddJointPosBufferRequest.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_AddJointPosBufferRequest;
            obj.reload(strObj);
        end
    end
end
