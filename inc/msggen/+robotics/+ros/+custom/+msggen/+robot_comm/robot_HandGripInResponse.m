classdef robot_HandGripInResponse < robotics.ros.Message
    %robot_HandGripInResponse MATLAB implementation of robot_comm/robot_HandGripInResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_HandGripInResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_HandGripInResponse(msg)
            %robot_HandGripInResponse Construct the message object robot_HandGripInResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_HandGripInResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_HandGripInResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_HandGripInResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_HandGripInResponse;
            obj.reload(strObj);
        end
    end
end
