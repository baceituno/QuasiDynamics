classdef robot_HandMoveToResponse < robotics.ros.Message
    %robot_HandMoveToResponse MATLAB implementation of robot_comm/robot_HandMoveToResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_HandMoveToResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_HandMoveToResponse(msg)
            %robot_HandMoveToResponse Construct the message object robot_HandMoveToResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_HandMoveToResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_HandMoveToResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_HandMoveToResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_HandMoveToResponse;
            obj.reload(strObj);
        end
    end
end
