classdef robot_SetAccResponse < robotics.ros.Message
    %robot_SetAccResponse MATLAB implementation of robot_comm/robot_SetAccResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetAccResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetAccResponse(msg)
            %robot_SetAccResponse Construct the message object robot_SetAccResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetAccResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_SetAccResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetAccResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetAccResponse;
            obj.reload(strObj);
        end
    end
end
