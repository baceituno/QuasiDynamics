classdef robot_HandJogInResponse < robotics.ros.Message
    %robot_HandJogInResponse MATLAB implementation of robot_comm/robot_HandJogInResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_HandJogInResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_HandJogInResponse(msg)
            %robot_HandJogInResponse Construct the message object robot_HandJogInResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_HandJogInResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_HandJogInResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_HandJogInResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_HandJogInResponse;
            obj.reload(strObj);
        end
    end
end
