classdef robot_JointsLog < robotics.ros.Message
    ...
    properties (Constant, Hidden)
        MD5Checksum = '5f7ad74dc7bfb734d791713bf14a7d98' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Date', 'J1', 'J2', 'J3', 'J4', 'J5', 'J6', 'J7', 'Time', 'TimeStamp'} % List of non-constant message properties
        ROSPropertyList = {'date', 'j1', 'j2', 'j3', 'j4', 'j5', 'j6', 'j7', 'time', 'timeStamp'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Date(obj, date)
            ...
            validateattributes(date, {'char', 'string'}, {}, 'robot_JointsLog', 'Date');
        ...
        function set.Time(obj, time)
            ...
            validateattributes(time, {'char', 'string'}, {}, 'robot_JointsLog', 'Time');
        ...
        function set.J7(obj, j7)
            ...
            validateattributes(j7, {'numeric'}, {'nonempty', 'scalar'}, 'robot_JointsLog', 'J7');
