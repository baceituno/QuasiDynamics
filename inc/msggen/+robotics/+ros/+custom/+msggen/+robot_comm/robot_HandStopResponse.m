classdef robot_HandStopResponse < robotics.ros.Message
    %robot_HandStopResponse MATLAB implementation of robot_comm/robot_HandStopResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_HandStopResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_HandStopResponse(msg)
            %robot_HandStopResponse Construct the message object robot_HandStopResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_HandStopResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_HandStopResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_HandStopResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_HandStopResponse;
            obj.reload(strObj);
        end
    end
end
