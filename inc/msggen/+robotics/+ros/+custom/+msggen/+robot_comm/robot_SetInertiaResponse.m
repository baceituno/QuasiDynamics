classdef robot_SetInertiaResponse < robotics.ros.Message
    %robot_SetInertiaResponse MATLAB implementation of robot_comm/robot_SetInertiaResponse
    ...
    properties (Constant)
        MessageType = 'robot_comm/robot_SetInertiaResponse' % The ROS message type
    end
    ...
    methods
        function obj = robot_SetInertiaResponse(msg)
            %robot_SetInertiaResponse Construct the message object robot_SetInertiaResponse
        ...
        function set.Ret(obj, ret)
            ...
            validateattributes(ret, {'numeric'}, {'nonempty', 'scalar'}, 'robot_SetInertiaResponse', 'Ret');
        ...
        function set.Msg(obj, msg)
            ...
            validateattributes(msg, {'char', 'string'}, {}, 'robot_SetInertiaResponse', 'Msg');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.robot_comm.robot_SetInertiaResponse.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.robot_comm.robot_SetInertiaResponse;
            obj.reload(strObj);
        end
    end
end
